...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Menu_vue__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_FormTask_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_FormTask_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_FormTask_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Task_vue__ = __webpack_require__(42);
...
var router = new __WEBPACK_IMPORTED_MODULE_2_vue_router__["a" /* default */]({
  ...
  routes: [{
    path: '/',
    name: 'root',
    component: __WEBPACK_IMPORTED_MODULE_5__components_Task_vue___default.a
  }, {
    path: '/see/:id',
    name: 'see',
    component: __WEBPACK_IMPORTED_MODULE_4__components_FormTask_vue___default.a,
    props: {
      newTask: false
    }
  }, {
...
Vue.component('app-menu', __WEBPACK_IMPORTED_MODULE_3__components_Menu_vue___default.a);
...
var render = function() {
  ...
  return _c("nav", { staticClass: "ui fixed inverted menu" }, [
    _c("div", { staticClass: "ui container" }, [
      _c(
        "a",
        {
          class: [{ active: _vm.menuIndex }, "yellow", "item"],
          attrs: { href: "#/" },
          on: {
      ...
      _c(
        "a",
        {
          class: [{ active: _vm.newTask }, "yellow", "item"],
          attrs: { href: "#/create" },
          on: {
            click: function($event) {
              _vm.activeThis(1)
...
Component.options.__file = "resources/assets/js/components/FormTask.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5eb5d120", Component.options)
  } else {
    hotAPI.reload("data-v-5eb5d120", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    show: function show(id) {
      ...
      this.axios.get('/task/' + id).then(function (response) {
    ...
    store: function store() {
      ...
      var task = this.computedFormData;

      this.axios.post('/task/new', task).then(function (response) {
    ...
    update: function update() {
      ...
      this.axios.patch('/task/' + task.id, task).then(function (response) {
    ...
    destroy: function destroy() {
      ...
      if (this.formdata.id !== null) this.axios.delete('/task/' + this.formdata.id).then(function (response) {
        window.location.href = '#/';
      }).catch(function (error) {
...
var render = function() {
  ...
  return _c("div", [
    !_vm.editTask && !_vm.newTask
      ? _c("div", { staticClass: "ui container" }, [
          _c("h1", { class: ["ui", { inverted: _vm.blackTheme }, "header"] }, [
          ...
          _c(
            "div",
            {
              class: ["ui", "raised", { inverted: _vm.blackTheme }, "segment"]
            },
            [
              _vm.formdata.completed == 1
                ? _c("p", { staticClass: "ui green ribbon label" }, [
                    _vm._v("Terminée")
                  ])
                : _vm._e(),
              _vm._v(" "),
              _vm.formdata.completed == 0
                ? _c("p", { staticClass: "ui blue ribbon label" }, [
                    _vm._v("Pas terminée")
                  ])
                : _vm._e(),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.formdata.content))]),
              _vm._v(" "),
              _c("p", [_vm._v(_vm._s(_vm.formdata.adate))])
            ]
          ),
          _vm._v(" "),
          _c("div", [
          ...
          _c("div", { class: ["ui", { inverted: _vm.blackTheme }, "form"] }, [
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.formdata, "title", $event.target.value.trim())
                  },
                  blur: function($event) {
                    _vm.$forceUpdate()
                  }
            ...
            _c("div", { staticClass: "field" }, [
              ...
              _c(
                ...
                [_vm._v(_vm._s(_vm.formdata.content))]
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "field" }, [
              _c("label", [_vm._v("Date limite")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model.trim",
                    value: _vm.formdata.adate,
                    expression: "formdata.adate",
                    modifiers: { trim: true }
                  }
                ],
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.formdata, "adate", $event.target.value.trim())
                  },
                  blur: function($event) {
                    _vm.$forceUpdate()
                  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5eb5d120", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getTasks: function getTasks() {
      ...
      this.axios.get('/task/list').then(function (response) {
        ...
        return _c(
          ...
          [
            _c(
              "button",
              {
                class: _vm.classCompleted(task.completed),
                attrs: { href: "javascript:;" },
                on: {
                  click: function($event) {
                    _vm.completed(task, task.completed)
                  }
                }
              },
              [
                _vm._v(
                  "\n      " +
                    _vm._s(_vm.textCompleted(task.completed)) +
                    "\n    "
                )
              ]
            ),
            ...
            _c("div", { staticClass: "ui grid" }, [
              _c("div", { staticClass: "thirteen wide column" }, [
                ...
                _vm._v(" "),
                _c("p", { staticClass: "fsxs" }, [_vm._v(_vm._s(task.adate))])
              ]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "one wide column" },
                [
                  _c(
                    "router-link",
                    {
                      staticClass: "circular ui icon button yellow",
                      attrs: { to: { name: "see", params: { id: task.id } } }
                    },
                    [
                      _c("i", {
                        staticClass: "fa fa-eye fa-2x yellow",
